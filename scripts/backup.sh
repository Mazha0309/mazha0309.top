...
This archive contains CMS content, revisions, project/page settings, media metadata,
and media files. Better Auth tables, sessions, OAuth tokens, secrets, and raw
